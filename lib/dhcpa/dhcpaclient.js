...
function DHCPAClient(options) {
    ...
    this.client.on('message', (msg, rinfo) => {
        ...
        case DHCPA.Message.TYPES.DHCP_OFFER:
            this.emit('offer', rinfo, pkt);
            break;
        case DHCPA.Message.TYPES.DHCP_ACK:
            this.emit('acknowledge', pkt);
            break;
        case DHCPA.Message.TYPES.DHCP_NAK:
            this.emit('deny', pkt);
            break;
        default:
...
DHCPAClient.prototype.createRequestPacket = function(user) {
	user.options.dhcpMessageType = DHCPA.Message.TYPES.DHCP_REQUEST.value;
