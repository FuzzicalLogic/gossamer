...
function Server(options) {
    ...
    this.server.on('message', (msg, rinfo) => {
		...
		case protocol.DHCPMessageType.DHCP_DISCOVER:
			this.emit('discover', rinfo, pkt);
			break;
		case protocol.DHCPMessageType.DHCP_REQUEST:
			this.emit('request', rinfo, pkt);
			break;
		case protocol.DHCPMessageType.DHCP_RELEASE:
...
Server.prototype.createOfferPacket = function(user) {
	user.options.dhcpMessageType = protocol.DHCPMessageType.DHCP_OFFER.value;
    return Server.prototype.createPacket(user);
}
